...
// src/app/onboarding/_steps/StepTeam.tsx
// =============================================================================
// LUSTRE — Onboarding Step 3: Team
// Invite team members / cleaners. This is a high-stickiness moment.
// For now just collects email(s) — actual invite emails come in Phase 2
// when we wire up Resend. For now we store pending invites or skip.
// =============================================================================
...
export default function StepTeam({ organisationId }: { organisationId: string }) {
  // We use a simple form action that just advances the step.
  // Full invite flow (email sending) comes in Phase 2 with Resend.
  ...
  return (
    <div>
      ...
      {/* Invite input — UI only for now, full email invites in Phase 2 */}
      <div className="mb-6 rounded-lg border border-dashed border-zinc-200 bg-white px-5 py-6 text-center">
        ...
        <p className="mt-1 text-xs text-zinc-400">
          You'll be able to invite cleaners by email in the next update.
